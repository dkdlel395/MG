...
-- Foreign Key 설정 SQL - species_for_mbti(species_one) -> species_information(no)
...
-- Foreign Key 설정 SQL - species_for_mbti(species_two) -> species_information(no)
ALTER TABLE species_for_mbti
...
INSERT INTO `abandoned_animal` (`animal_id`, `animal_name`, `species`, `gender`, `age`, `weight`, `personality`, `reason_for_abandonment`, `potty_training`, `abuse`, `disease`, `shyness`, `loneliness`, `introduction`, `location`, `shelter_name`, `increased_friends`, `total_friends`, `upload_status`, `registration_date`, `profile_image`, `diffusion_profile_image`) VALUES ('abc003', '초코쿠키', 3, '암컷', 4, 12, '외향적', '파양', b'0', b'0', '없음', 0, 0, '사람을 너무 좋아하는 애교둥이 귀여운 빵댕이 초코쿠키예요~.', '서울', '서울동물복지센터 마포', 0, 0, '보호중', '2021-11-19', 'https://firebasestorage.googleapis.com/v0/b/chubinibini.appspot.com/o/cloud%2F%EC%B4%88%EC%BD%94%EC%BF%A0%ED%82%A4.PNG?alt=media&token=441c431b-4b49-48ef-99e3-82b9da047c1a', 'https://firebasestorage.googleapis.com/v0/b/rookies-93984.appspot.com/o/4.%EC%B4%88%EC%BD%94%EC%BF%A0%ED%82%A4.png?alt=media&token=427d90f6-fb41-4630-ac0b-44cdf0756273');

...
CREATE TABLE `abandoned_animal` (
   ...
   `propile` char(250) NULL DEFAULT NULL,
...
'쿠팡', 1,'암',1,2,'외향적',
'주인사망',0,0,'없음',5,5,'안녕','인천','사랑보호소',10,10,'보호중','2023-05-03 21:26:51','https://firebasestorage.googleapis.com/v0/b/carscratch.appspot.com/o/image%2F%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C.jfif?alt=media&token=0c7051dd-1264-46c2-a9aa-66873632c9c8');

insert into abandoned_animal values('1111111112',
'뽀또', 1,'암',1,2,'외향적',
'주인사망',0,0,'없음',5,5,'안녕','인천','사랑보호소',12,12,'보호중','2023-05-03 21:26:52', 'https://firebasestorage.googleapis.com/v0/b/carscratch.appspot.com/o/image%2F%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C.jfif?alt=media&token=0c7051dd-1264-46c2-a9aa-66873632c9c8');

insert into abandoned_animal values('1111111113',
'베이크', 1,'수',1,2,'외향적',
'주인사망',0,0,'없음',5,5,'안녕','인천','사랑보호소',11,11,'보호중','2023-05-03 21:26:53', 'https://firebasestorage.googleapis.com/v0/b/carscratch.appspot.com/o/image%2F%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C.jfif?alt=media&token=0c7051dd-1264-46c2-a9aa-66873632c9c8');